        ...
        <div class="row portfolio-wrapper">
                ...
                <a class="work-content" href="#damamaya-dialog">
                    <div class="portfolio-item shadow-dark rounded">
                        <div class="details">
                            ...
                            <h3 class="title">
                                Damamaya Cyber Monitor
                                {{-- <br><br>
                                <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque eius, a repudiandae magni nisi dicta.</small> --}}
                            </h3>
                        </div>
                        <div class="thumb">
                            <img loading="lazy" src="{{ asset('assets/images/projects/app-damamaya/login.webp') }}"
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 grid-item mb-5">
                <a class="work-content" href="#scheduler-dialog">
                    <div class="portfolio-item shadow-dark rounded">
                        ...
                        <div class="thumb">
                            <img loading="lazy" src="{{ asset('assets/images/projects/app-scheduler/login.webp') }}"
                                alt="Portfolio thumbnail image" />
                            <div class="mask"></div>
                        </div>
                    </div>
                ...
                <div class="white-popup zoom-anim-dialog mfp-hide" id="scheduler-dialog">
                    ...
                    <div class="d-block d-md-flex justify-content-between gap-2">
                        <a class="btn btn-default w-100 mt-2" href="https://github.com/arieesetiadi/penjadwalan-app"
                            target="_blank">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 grid-item mb-5">
                ...
                <div class="white-popup zoom-anim-dialog mfp-hide" id="mytodo-dialog">
                    ...
                    <div class="d-block d-md-flex justify-content-between gap-2">
                        <a class="btn btn-default w-100 mt-2" href="https://github.com/arieesetiadi/my-todo-client"
                            target="_blank">
                            Github - Frontend
                        </a>
                        <a class="btn btn-default w-100 mt-2" href="https://github.com/arieesetiadi/my-todo-server"
                            target="_blank">
                            Github - Backend
                        </a>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 grid-item mb-5">
                <a class="work-content" href="#kerambitan-dialog">
                    <div class="portfolio-item shadow-dark rounded">
                        ...
                        <div class="thumb">
                            <img loading="lazy" src="{{ asset('assets/images/projects/site-kerambitan/home.webp') }}"
                                alt="Portfolio thumbnail image" />
                            <div class="mask"></div>
                        </div>
                    </div>
                ...
                <div class="white-popup zoom-anim-dialog mfp-hide" id="kerambitan-dialog">
                    ...
                    <div class="d-block d-md-flex justify-content-between gap-2">
                        <a class="btn btn-default w-100 mt-2" href="https://github.com/arieesetiadi/vtour-180030179"
                            target="_blank">
                            Check on Github
                        </a>
                    </div>
                ...
                <a class="work-content" href="#spkt-dialog">
                    <div class="portfolio-item shadow-dark rounded">
                        <div class="details">
                            <span class="term">Web App</span>
                            <h3 class="title">
                                Badung Integrated Police Service Center
                            </h3>
                        </div>
                        <div class="thumb">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 grid-item d-none mb-5">
                ...
                <div class="white-popup zoom-anim-dialog mfp-hide" id="api-cashier-dialog">
                    ...
                    <div class="d-block d-md-flex justify-content-between gap-2">
                        <a class="btn btn-default w-100 mt-2" href="https://github.com/arieesetiadi/api-cashier-app"
                            target="_blank">
                            Check on Github
                        </a>
                    </div>
